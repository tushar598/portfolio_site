...
const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-16 sm:py-20 md:py-24 bg-brand-orange dark:bg-brand-dark transition-colors duration-500 relative overflow-hidden">
      ...
      <div ref={containerRef} className="container mx-auto px-4 sm:px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 relative">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 relative overflow-hidden group">
              ...
              <h2 className="text-white font-display font-bold text-3xl sm:text-4xl md:text-5xl mb-4 sm:mb-6 relative z-10">
                Passion-Driven<br />Development
              </h2>
              <div className="w-16 sm:w-20 h-1 bg-white mb-4 sm:mb-6 relative z-10"></div>

              <p className="text-white/80 leading-relaxed mb-4 sm:mb-6 font-sans text-sm sm:text-base relative z-10">
              ...
              <p className="text-white/80 leading-relaxed mb-6 sm:mb-8 font-sans text-sm sm:text-base relative z-10">
                My journey revolves around full-stack development,blockchain, data structures & algorithms, and crafting seamless user experiences. I believe in writing maintainable code while constantly exploring new technologies.
              </p>
              ...
              <div className="relative z-10">
                <Button variant="primary" icon onClick={() => window.open('/TusharFinalResume.pdf', '_blank')}>Download CV</Button>
              </div>
            </div>
          </div>
