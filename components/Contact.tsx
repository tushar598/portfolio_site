            ...
            <div className="container mx-auto px-6 md:px-12">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 border border-white/10">
                    <div>
                        ...
                        <div className="flex flex-col gap-2 text-sm font-bold opacity-80">
                            <span>Dewas, MP, India</span>
                            <a href="mailto:hello@example.com" className="hover:text-brand-orange transition-colors">hello@example.com</a>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 md:gap-6 flex-wrap justify-center">
                        {[
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className={`w-14 h-14 md:w-20 md:h-20 rounded-xl flex items-center justify-center border border-white/20 hover:border-white transition-all hover:-translate-y-2 group bg-white/5 overflow-hidden relative will-change-transform`}
                            >
                ...
                <div className="mt-20 flex flex-col md:flex-row justify-between items-end border-t border-white/10 pt-8">
                    <div className="flex items-center gap-2 mb-4 md:mb-0">
                        <div className="bg-white dark:bg-brand-accent text-brand-blue dark:text-brand-dark font-display font-bold text-2xl px-2 py-1 rounded-sm">CD</div>
